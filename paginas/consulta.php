...
<body>
    ...
    <section style="margin-top: 30px; margin-bottom: 30px;" class="formulario">
        <div class="borda">
            ...
            <button type="submit" class="botao" style="margin: 10;">Salvar</button>
            <a href="/excluir.php?id=<?php echo $portifolio->id ?>">
                <button type="button" class="botao excluir" style="margin: 10;">Excluir</button>
            </a>
            </div>
            <br><br>
